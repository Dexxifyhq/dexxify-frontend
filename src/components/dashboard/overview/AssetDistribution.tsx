...
function Skeleton() {
  return (
    <div className="flex flex-col items-center gap-4 py-6">
      <div className="h-44 w-44 animate-pulse rounded-full bg-dash-hover" />
    ...
    <div className="flex flex-col gap-4 rounded-xl border border-dash-border bg-dash-card p-5 h-full">
      ...
      {isEmpty && (
        <div className="flex flex-col items-center justify-center flex-1 gap-2 py-8">
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] font-semibold uppercase tracking-wider text-dash-faint">
              TOTAL
            </p>
          </div>
        </div>
      ...
      {!loading && data && data.assets.length > 0 && (
        <>
          ...
          <div className="relative flex h-44 w-44 mx-auto items-center justify-center">
            <svg viewBox="0 0 36 36" className="h-full w-full -rotate-90">
            ...
            <div className="absolute text-center">
              <p className="text-lg font-bold text-dash-foreground">
                ${data.total_usd.toLocaleString()}
              </p>
              <p className="text-[9px] font-semibold uppercase tracking-wider text-dash-faint">
                TOTAL
              </p>
            </div>
          </div>
