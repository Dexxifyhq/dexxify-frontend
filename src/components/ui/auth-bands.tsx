/**
 * Diagonal bands in ramp greys, pinned to the bottom of a dark side panel.
 * Shared by the (auth) layout and the welcome page.
 *
 * Fills are set via style: SVG presentation attributes don't resolve CSS
 * variables. Decorative — the caller's container should be aria-hidden.
 */
